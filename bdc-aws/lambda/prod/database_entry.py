...
def update_database(blade_number, file_size, upload_time, field):
    ...
    print ('blade_number after removing Blade_ ', blade_number)
    
    print ('update_database update_query', update_query)
    ...
    try:
        for record in event['Records']:
            ...
            if s3_object_key.startswith(cv_pipeline_input):
                ...
                print(f"Blade : {blade_name}, Size: {file_size}")
...
def processedFileName(s3_object_key):
    ...
    print('processedFileName ',blade_name)
    return blade_name
