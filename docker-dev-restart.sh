...
docker compose --env-file ./.env -f ./docker-compose-dev.yml down bdc-srv bdc-ui dbc-db
docker compose --env-file ./.env -f ./docker-compose-dev.yml up -d --no-deps bdc-db bdc-srv bdc-ui 
